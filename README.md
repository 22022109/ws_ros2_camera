...
[person_id, x0, y0, x1, y1, ..., x16, y16, vx, vy, direction_code, confidence, timestamp] 
  ...
  1. person_id: Unique ID to track same person
  
  2. 17 keypoints: All skeleton joints (x, y)
  
  3. velocity: vx, vy in pixels/frame
  
  4. direction_code: 0-7 (Up, Up-Right, Right, ...)
  
  5. confidence: YOLO detection confidence 0-1
  
  6. timestamp: ROS2 time in seconds
